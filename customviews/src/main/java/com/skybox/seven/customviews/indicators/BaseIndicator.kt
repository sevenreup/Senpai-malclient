...
abstract class BaseIndicator @JvmOverloads constructor(
    ...
    enum class Type(
        ...
        DEFAULT(
            16f,
            8f,
            R.styleable.DefaultIndicator,
            R.styleable.DefaultIndicator_dotsColor,
            R.styleable.DefaultIndicator_dotsSize,
            R.styleable.DefaultIndicator_dotsSpacing,
            R.styleable.DefaultIndicator_dotsCornerRadius
        )
//        SPRING(
//            16f,
//            4f,
