 ...
 * Use the [AnimeDescriptionFragment.newInstance] factory method to
...
class AnimeDescriptionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AnimeDescriptionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AnimeDescriptionFragment().apply {
