...
@EpoxyModelClass(layout = R.layout.model_character_one)
abstract class StaffOneModel: EpoxyModelWithHolder<StaffOneModel.AnimeOneHolder>(){
    val holderType = 0
    ...
    override fun getDefaultLayout(): Int {
        return R.layout.model_character_one
    }
